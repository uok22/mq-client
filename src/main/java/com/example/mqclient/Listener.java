...
public class Listener {
  ...
  @JmsListener(destination = MqClientApplication.qName)
  public void receiveMessage(Person msg) {
    infinityWarning();
  ...
  void infinityWarning() {
    if (!warned) {
      ...
      System.out.println();
      System.out.println("========================================");
      System.out.println("MQ JMS Listener started for queue: " + MqClientApplication.qName);
